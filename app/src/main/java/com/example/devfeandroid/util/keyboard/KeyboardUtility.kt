...
class KeyboardUtility {
    companion object {
        ...
        fun isKeyboardShown(context: Context, editText: EditText): Boolean {
            val imm: InputMethodManager? = context.getSystemService(Context.INPUT_METHOD_SERVICE) as? InputMethodManager
            return imm != null && imm.isActive(editText)
        }
        ...
        /**
         * lắng nghe show hide key board
         */
        fun onEventCallBackShowKeyBoard(
            activity: Activity?,
            listener: KeyboardVisibilityEventListener?,
        ) {
            KeyboardVisibilityEvent.registerEventListener(activity, listener)
        }
    }
}
